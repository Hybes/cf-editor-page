<template>
  <div class="w-screen h-screen flex flex-col gap-2 justify-center items-center">
    ...
    <input @keydown.enter="saveApiKey" v-model="apiKey" class="w-11/12 md:w-3/4 border-2 border-black p-2 rounded-sm" autofocus type="text"
      name="API Key" id="cf-api-key">
    <button @click="saveApiKey" class="bg-blue-500 text-white px-4 py-1 rounded-sm" type="button">Submit</button>
  </div>
</template>
