		...
		<div class="flex min-h-[80vh] w-screen flex-col items-center justify-center gap-2">
			...
			>
				<div
					v-if="zones.length > 0"
					@click="setZone(zone)"
					class="group flex cursor-pointer items-center justify-between rounded-md bg-stone-100 px-4 py-2 hover:bg-stone-200 dark:bg-stone-700 dark:hover:bg-stone-800"
